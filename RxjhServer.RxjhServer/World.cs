...
namespace RxjhServer.RxjhServer
{
	public class World
	{
		...
		public static string BossMonsterStormIceApparitionColdJadeDefense;

		public static int BossMonsterStormIceApparitionColdJadeTypeSetting;

		public static string BossMonsterStormIceSoulColdJadeMartialArtsDefense;

		public static string BossMonsterStormJade;

		public static string BossStrangeStormMixedElementDiamond;

		public static string BossStrangeDiamond;

		public static string BossMonsterViolentFrostAndColdJadeDefense;

		public static int BossMonsterViolentCondensationFrostColdJadeTypeSetting;

		public static string BossStrangeViolentCondensationFrostColdJadeMartialArtsDefense;

		public static string BossStrangeViolentUniverseDiamond;

		public static string BossMonsterViolentBloodStone;

		public static string BossStrangeStormMysteriousDiamondMartialArts;

		public static string BossStrangeStormMysteriousDiamondChase;

		public static int BossMonsterStormAttributeStone;
		...
		public static ThreadSafeDictionary<int, ClientIPAddress> Iplist;

		public static Dictionary<int, ItmeClass> Itme;

		public static List<TableOfMedicines> listOfMedicines;

		public static ThreadSafeDictionary<long, GroundItems> ItmeTeM;
		...
		public static int PkGradeDifference;

		public static int PkDropLevel;

		public static int PkDropIngot;

		public static int PkLostIngotSystemRecoveryVolume;

		public static int PkDropEquipment;

		public static int PkEquipmentDropChance;

		public static int PkEquipmentGoodAndEvil;

		public static int PkSwitch;

		public static string[] PkSystemRestrictionMap;
		...
		public static Dictionary<int, MartialArts> TblKongfu;
		...
		public static string VipMap;

		public static string Config_Reward_Online_Vip;

		public static double VipSynthesisRate;

		public static double VipEXPMultiplierPercentage;

		public static double VipExperienceMultiplierPercentage;

		public static int VipOnlineAnnouncement;

		public static string VipLaunchAnnouncementContent;

		public static int ColorfulOnlineSignature;

		public static string ColorfulOnlineSignatureContent;

		public static int VipLine;

		public static Dictionary<int, double> Wxlever;

		public static Dictionary<int, TeamClass> PartyClass;

		public static int WTeamID;

		public static List<CoordinateClass> SafePlace;

		public static float SafeAreaXCoordinate;

		public static float SafeAreaYCoordinate;

		public static int SafeZoneMap;

		public static int SafeZoneSwitch;

		public static string BaibaoPavilionIceSoulColdJadeDefense;

		public static int BaibaogeIceSoulJadeTypeSetting;

		public static string BaibaoPavilionIceSoulColdJadeMartialArtsDefense;
		...
		public static List<CoordinateClass> Map_Move;
		...
		public static int MaxNumberOfConnectionsToTheGameLoginPorts;
		...
		private void WorldEventTimer5Sec(object sender, ElapsedEventArgs e)
		{
			foreach (Players value2 in AllConnectedChars.Values)
			{
				...
				{
					if (PartyClass.TryGetValue(value2.Party_ID, out TeamClass value))
					{
		...
		public static int GetStoneValue(int pid, int type)
		{
			...
			if (pid > 800000013)
			{
				...
				case 800000023:
				{
					...
					case 3:
						...
						break;
					case 4:
						array49 = BossStrangeStormMixedElementDiamond.Split(';');
						break;
					case 5:
				...
				case 800000024:
					...
					case 5:
						...
						break;
					case 4:
						switch (BossMonsterStormIceApparitionColdJadeTypeSetting)
						{
						case 0:
						{
							if (random.Next(1, 100) <= 50)
							{
								string[] array3 = BossMonsterStormIceApparitionColdJadeDefense.Split(';');
								return GetStoneValue_Fix(Convert.ToInt32(array3[0]), Convert.ToInt32(array3[1]));
							}
							string[] array34 = BossMonsterStormIceSoulColdJadeMartialArtsDefense.Split(';');
							return GetStoneValue_Fix(Convert.ToInt32(array34[0]), Convert.ToInt32(array34[1]));
						}
						case 1:
						{
							string[] array33 = BossMonsterStormIceApparitionColdJadeDefense.Split(';');
							return GetStoneValue_Fix(Convert.ToInt32(array33[0]), Convert.ToInt32(array33[1]));
						}
						case 2:
						{
							string[] array32 = BossMonsterStormIceSoulColdJadeMartialArtsDefense.Split(';');
					...
					case 3:
						...
						break;
					case 2:
						switch (BaibaogeIceSoulJadeTypeSetting)
						{
						case 0:
						{
							if (random.Next(1, 100) <= 50)
							{
								string[] array3 = BaibaoPavilionIceSoulColdJadeDefense.Split(';');
								return GetStoneValue_Fix(Convert.ToInt32(array3[0]), Convert.ToInt32(array3[1]));
							}
							string[] array28 = BaibaoPavilionIceSoulColdJadeMartialArtsDefense.Split(';');
							return GetStoneValue_Fix(Convert.ToInt32(array28[0]), Convert.ToInt32(array28[1]));
						}
						case 1:
						{
							string[] array27 = BaibaoPavilionIceSoulColdJadeDefense.Split(';');
							return GetStoneValue_Fix(Convert.ToInt32(array27[0]), Convert.ToInt32(array27[1]));
						}
						case 2:
						{
							string[] array26 = BaibaoPavilionIceSoulColdJadeMartialArtsDefense.Split(';');
				...
				case 800000025:
				{
					...
					case 3:
						...
						break;
					case 4:
						array48 = BossStrangeStormMysteriousDiamondChase.Split(';');
						break;
					case 5:
				...
				case 800000026:
				{
					...
					case 3:
						...
						break;
					case 4:
						array50 = BossStrangeStormMysteriousDiamondMartialArts.Split(';');
						break;
					case 5:
				...
				case 800000028:
				{
					...
					case 3:
						...
						break;
					case 4:
						switch (BossMonsterStormAttributeStone)
									{
						case 0:
							num2 = new Random(GetRandomSeed()).Next(1, 7);
							break;
				...
				case 800000061:
				{
					...
					case 3:
						...
						break;
					case 4:
						array44 = BossStrangeViolentUniverseDiamond.Split(';');
						break;
					case 5:
				...
				case 800000062:
					...
					case 5:
						...
						break;
					case 4:
						switch (BossMonsterViolentCondensationFrostColdJadeTypeSetting)
								{
						case 0:
						{
							if (random.Next(1, 100) <= 50)
							{
								string[] array3 = BossMonsterViolentFrostAndColdJadeDefense.Split(';');
								return GetStoneValue_Fix(Convert.ToInt32(array3[0]), Convert.ToInt32(array3[1]));
							}
							string[] array13 = BossStrangeViolentCondensationFrostColdJadeMartialArtsDefense.Split(';');
							return GetStoneValue_Fix(Convert.ToInt32(array13[0]), Convert.ToInt32(array13[1]));
						}
						case 1:
						{
							string[] array12 = BossMonsterViolentFrostAndColdJadeDefense.Split(';');
							return GetStoneValue_Fix(Convert.ToInt32(array12[0]), Convert.ToInt32(array12[1]));
						}
						case 2:
						{
							string[] array11 = BossStrangeViolentCondensationFrostColdJadeMartialArtsDefense.Split(';');
			...
			case 800000011:
			{
				...
				case 3:
					...
					break;
				case 4:
					array53 = BossStrangeDiamond.Split(';');
					break;
				case 5:
					array53 = 奖励金刚石.Split(';');
					break;
			...
			case 800000012:
			{
				...
				case 3:
					...
					break;
				case 4:
					array52 = BossMonsterStormJade.Split(';');
					break;
				case 5:
					array52 = 奖励寒玉石.Split(';');
					break;
			...
			case 800000013:
			{
				...
				case 3:
					...
					break;
				case 4:
					array51 = BossMonsterViolentBloodStone.Split(';');
					break;
				case 5:
					array51 = 奖励热血石.Split(';');
					break;
		...
		private static void old_acctor_mc()
		{
			人物最高等级 = 255;
			SafeZoneMap = 101;
			SafeAreaXCoordinate = 412f;
			SafeAreaYCoordinate = 1512f;
			ServerVer = 5.0;
			ServerVerD = 0.0;
			ServerRegTime = "";
			Droplog = false;
			...
			Iplist = new ThreadSafeDictionary<int, ClientIPAddress>();
			...
			MaxNumberOfConnectionsToTheGameLoginPorts = 20;
			游戏登陆端口最大连接时间数 = 1000;
			查非法物品 = 0;
			查非法物品操作 = 3;
			查绑定非法物品 = false;
			...
			广播发送速度 = 0.0;
			接收速度 = 0.0;
			VipEXPMultiplierPercentage = 0.3;
			VipExperienceMultiplierPercentage = 0.3;
			经验倍数 = 100;
			吸魂机率 = 70;
			吸魂开关 = 0;
			吸魂随机数量 = "1;3";
			...
			PkSwitch = 0;
			启动职业气功热血石 = 0;
			VipOnlineAnnouncement = 0;
			VipLaunchAnnouncementContent = "尊贵的VIP玩家{0}上线了！大家欢迎！";
			ColorfulOnlineSignature = 0;
			ColorfulOnlineSignatureContent = "尊贵的七彩个性签名VIP玩家【{0}】呼啦啦的牛B上线了！大家欢迎！!!";
			坐牢杀人公告 = "{0}杀人啦！";
			刑满释放公告 = "{0}刑满释放了！";
			信任连接ip = "";
			允许多开数量 = 2;
			...
			try
			{
				...
				PartyClass = new Dictionary<int, TeamClass>();
				石头属性调整 = new Dictionary<int, 石头属性调整类>();
				...
				物品兑换数据 = new Dictionary<int, 物品兑换类>();
				转职属性数据 = new Dictionary<int, TransferAttributes>();
				ItmeTeM = new ThreadSafeDictionary<long, GroundItems>();
				TblKongfu = new Dictionary<int, MartialArts>();
				...
				listOfMedicines = new List<TableOfMedicines>();
				DropGs = new List<DropClass>();
				Open = new List<OpenClass>();
				Shot = new List<ShotClass>();
				Mover = new List<MoveClass>();
				Map_Move = new List<CoordinateClass>();
				SafePlace = new List<CoordinateClass>();
			}
			catch (Exception arg)
			{
		...
		public static void SetConfig()
		{
			try
			{
				...
				MaxNumberOfConnectionsToTheGameLoginPorts = ((Config.IniReadValue("GameServer", "MaxNumberOfConnectionsToTheGameLoginPorts") == "") ? MaxNumberOfConnectionsToTheGameLoginPorts : int.Parse(Config.IniReadValue("GameServer", "MaxNumberOfConnectionsToTheGameLoginPorts")));
				...
				VipEXPMultiplierPercentage = ((Config.IniReadValue("GameServer", "VIPEXPMultiplierPercentage") == "") ? VipEXPMultiplierPercentage : double.Parse(Config.IniReadValue("GameServer", "VIPEXPMultiplierPercentage")));
				VipExperienceMultiplierPercentage = ((Config.IniReadValue("GameServer", "VIPExperienceMultiplierPercentage") == "") ? VipExperienceMultiplierPercentage : double.Parse(Config.IniReadValue("GameServer", "VIPExperienceMultiplierPercentage")));
				...
				VipLine = ((!(Config.IniReadValue("GameServer", "vipLine").Trim() == "")) ? int.Parse(Config.IniReadValue("GameServer", "vipLine").Trim()) : 0);
				PkSwitch = int.Parse(Config.IniReadValue("GameServer", "PkSwitch").Trim());
				PkDropEquipment = int.Parse(Config.IniReadValue("GameServer", "PkDropEquipment").Trim());
				PkEquipmentGoodAndEvil = int.Parse(Config.IniReadValue("GameServer", "PkEquipmentGoodAndEvil").Trim());
				PkEquipmentDropChance = int.Parse(Config.IniReadValue("GameServer", "PkEquipmentDropChance").Trim());
				...
				VipOnlineAnnouncement = ((Config.IniReadValue("GameServer", "VipOnlineAnnouncement").Trim() == "") ? VipOnlineAnnouncement : int.Parse(Config.IniReadValue("GameServer", "VipOnlineAnnouncement").Trim()));
				...
				ColorfulOnlineSignature = ((Config.IniReadValue("GameServer", "ColorfulOnlineSignature").Trim() == "") ? ColorfulOnlineSignature : int.Parse(Config.IniReadValue("GameServer", "ColorfulOnlineSignature").Trim()));
				...
				SafeZoneSwitch = ((Config.IniReadValue("GameServer", "SafeZoneSwitch").Trim() == "") ? SafeZoneSwitch : int.Parse(Config.IniReadValue("GameServer", "SafeZoneSwitch").Trim()));
				VipLaunchAnnouncementContent = ((Config.IniReadValue("GameServer", "VipLaunchAnnouncementContent").Trim() == "") ? VipLaunchAnnouncementContent : Config.IniReadValue("GameServer", "VipLaunchAnnouncementContent").Trim());
				ColorfulOnlineSignatureContent = ((Config.IniReadValue("GameServer", "ColorfulOnlineSignatureContent").Trim() == "") ? ColorfulOnlineSignatureContent : Config.IniReadValue("GameServer", "ColorfulOnlineSignatureContent").Trim());
				VipMap = Config.IniReadValue("GameServer", "VIPMap").Trim();
				...
				VipSynthesisRate = ((Config.IniReadValue("GameServer", "VIPSynthesisRate") == "") ? VipSynthesisRate : double.Parse(Config.IniReadValue("GameServer", "VIPSynthesisRate")));
				...
				PkGradeDifference = int.Parse(Config.IniReadValue("GameServer", "PkGradeDifference").Trim());
				...
				SafeZoneMap = int.Parse(Config.IniReadValue("GameServer", "SafeZoneMap").Trim());
				SafeAreaXCoordinate = float.Parse(Config.IniReadValue("GameServer", "SafeAreaXCoordinate").Trim());
				SafeAreaYCoordinate = float.Parse(Config.IniReadValue("GameServer", "SafeAreaYCoordinate").Trim());
				PkSystemRestrictionMap = Config.IniReadValue("GameServer", "PkSystemRestrictionMap").Trim().Split(';');
				PkDropLevel = int.Parse(Config.IniReadValue("GameServer", "PkDropLevel").Trim());
				PkDropIngot = int.Parse(Config.IniReadValue("GameServer", "PkDropIngot").Trim());
				PkLostIngotSystemRecoveryVolume = int.Parse(Config.IniReadValue("GameServer", "PkLostIngotSystemRecoveryVolume").Trim());
		...
		public static void SetTableOfMedicines()
		{
			DataTable dBToDataTable = DBA.GetDBToDataTable($"SELECT * FROM TBL_TableOfMedicines", "PublicDb");
			if (dBToDataTable == null)
			{
				return;
			}
			if (dBToDataTable.Rows.Count == 0)
			{
				Form1.WriteLine(1, "TBL_TableOfMedicines is null");
			}
			else
			{
				...
				for (int i = 0; i < dBToDataTable.Rows.Count; i++)
				{
					TableOfMedicines TableOfMedicines = new TableOfMedicines();
					TableOfMedicines.FLD_ZZWPID = (int)dBToDataTable.Rows[i]["FLD_ZZWPID"];
					TableOfMedicines.FLD_NAME = dBToDataTable.Rows[i]["FLD_NAME"].ToString();
					TableOfMedicines.FLD_XHWPID1 = (int)dBToDataTable.Rows[i]["FLD_XHWPID1"];
					TableOfMedicines.FLD_XHWPNUM1 = (int)dBToDataTable.Rows[i]["FLD_XHWPNUM1"];
					TableOfMedicines.FLD_XHWPID2 = (int)dBToDataTable.Rows[i]["FLD_XHWPID2"];
					TableOfMedicines.FLD_XHWPNUM2 = (int)dBToDataTable.Rows[i]["FLD_XHWPNUM2"];
					TableOfMedicines.FLD_XHWPID3 = (int)dBToDataTable.Rows[i]["FLD_XHWPID3"];
					TableOfMedicines.FLD_XHWPNUM3 = (int)dBToDataTable.Rows[i]["FLD_XHWPNUM3"];
					TableOfMedicines.FLD_XHWPID4 = (int)dBToDataTable.Rows[i]["FLD_XHWPID4"];
					TableOfMedicines.FLD_XHWPNUM4 = (int)dBToDataTable.Rows[i]["FLD_XHWPNUM4"];
					listOfMedicines.Add(TableOfMedicines);
				}
				Form1.WriteLine(2, "TBL_TableOfMedicines loaded: " + dBToDataTable.Rows.Count);
			}
			dBToDataTable.Dispose();
		}
		...
		public static void SetKongfu()
		{
			...
			else
			{
				...
				for (int i = 0; i < dBToDataTable.Rows.Count; i++)
				{
					...
					MartialArts.FLD_AT = (int)dBToDataTable.Rows[i]["FLD_AT"];
					MartialArts.FLD_EFFERT = (int)dBToDataTable.Rows[i]["FLD_EFFERT"];
					MartialArts.FLD_INDEX = (int)dBToDataTable.Rows[i]["FLD_INDEX"];
					MartialArts.FLD_JOB = (int)dBToDataTable.Rows[i]["FLD_JOB"];
					MartialArts.FLD_JOBLEVEL = (int)dBToDataTable.Rows[i]["FLD_JOBLEVEL"];
					MartialArts.FLD_LEVEL = (int)dBToDataTable.Rows[i]["FLD_LEVEL"];
					MartialArts.FLD_MP = (int)dBToDataTable.Rows[i]["FLD_MP"];
					MartialArts.FLD_NEEDEXP = (int)dBToDataTable.Rows[i]["FLD_NEEDEXP"];
					MartialArts.FLD_PID = (int)dBToDataTable.Rows[i]["FLD_PID"];
					MartialArts.FLD_TYPE = (int)dBToDataTable.Rows[i]["FLD_TYPE"];
					MartialArts.FLD_ZX = (int)dBToDataTable.Rows[i]["FLD_ZX"];
					MartialArts.FLD_攻击数量 = (int)dBToDataTable.Rows[i]["FLD_攻击数量"];
					MartialArts.FLD_武功类型 = (int)dBToDataTable.Rows[i]["FLD_武功类型"];
					MartialArts.FLD_每级加等级 = (int)dBToDataTable.Rows[i]["FLD_每级加等级"];
					MartialArts.FLD_每级加MP = (int)dBToDataTable.Rows[i]["FLD_每级加MP"];
					MartialArts.FLD_每级加历练 = (int)dBToDataTable.Rows[i]["FLD_每级加历练"];
					MartialArts.FLD_每级加危害 = (int)dBToDataTable.Rows[i]["FLD_每级加危害"];
					MartialArts.FLD_每级武功点数 = (int)dBToDataTable.Rows[i]["FLD_每级武功点数"];
					MartialArts.FLD_SKILL_TIME = (int)dBToDataTable.Rows[i]["FLD_TIME"];
					MartialArts.最高武功_等级 = (int)dBToDataTable.Rows[i]["FLD_武功最高等级"];
					MartialArts.FLD_每级加等级_Array = ((dBToDataTable.Rows[i]["FLD_每级加等级_Array"] != DBNull.Value) ? dBToDataTable.Rows[i]["FLD_每级加等级_Array"].ToString().Split(',').Select(int.Parse)
						.ToList() : new List<int>());
					MartialArts.FLD_每级加MP_Array = ((dBToDataTable.Rows[i]["FLD_每级加MP_Array"] != DBNull.Value) ? dBToDataTable.Rows[i]["FLD_每级加MP_Array"].ToString().Split(',').Select(int.Parse)
						.ToList() : new List<int>());
					MartialArts.FLD_每级加历练_Array = ((dBToDataTable.Rows[i]["FLD_每级加历练_Array"] != DBNull.Value) ? dBToDataTable.Rows[i]["FLD_每级加历练_Array"].ToString().Split(',').Select(int.Parse)
						.ToList() : new List<int>());
					MartialArts.FLD_每级加危害_Array = ((dBToDataTable.Rows[i]["FLD_每级加危害_Array"] != DBNull.Value) ? dBToDataTable.Rows[i]["FLD_每级加危害_Array"].ToString().Split(',').Select(int.Parse)
						.ToList() : new List<int>());
					TblKongfu.Add(MartialArts.FLD_PID, MartialArts);
				}
		...
		public static void SetstConfig()
		{
			try
			{
				...
				BaibaoPavilionIceSoulColdJadeMartialArtsDefense = Config.IniReadValust("StoneConfiguration", "BaibaoPavilionIceSoulColdJadeMartialArtsDefense").Trim();
				BaibaoPavilionIceSoulColdJadeDefense = Config.IniReadValust("StoneConfiguration", "BaibaoPavilionIceSoulColdJadeDefense").Trim();
				...
				BaibaogeIceSoulJadeTypeSetting = ((!(Config.IniReadValust("StoneConfiguration", "BaibaogeIceSoulJadeTypeSetting").Trim() == "")) ? int.Parse(Config.IniReadValust("StoneConfiguration", "BaibaogeIceSoulJadeTypeSetting").Trim()) : 0);
				...
				BossStrangeDiamond = Config.IniReadValust("StoneConfiguration", "BossStrangeDiamond").Trim();
				BossMonsterStormJade = Config.IniReadValust("StoneConfiguration", "BossMonsterStormJade").Trim();
				BossMonsterViolentBloodStone = Config.IniReadValust("StoneConfiguration", "BossMonsterViolentBloodStone").Trim();
				BossStrangeStormMixedElementDiamond = Config.IniReadValust("StoneConfiguration", "BossStrangeStormMixedElementDiamond").Trim();
				BossMonsterStormIceSoulColdJadeMartialArtsDefense = Config.IniReadValust("StoneConfiguration", "BossMonsterStormIceSoulColdJadeMartialArtsDefense").Trim();
				BossMonsterStormIceApparitionColdJadeDefense = Config.IniReadValust("StoneConfiguration", "BossMonsterStormIceApparitionColdJadeDefense").Trim();
				BossStrangeStormMysteriousDiamondChase = Config.IniReadValust("StoneConfiguration", "BossStrangeStormMysteriousDiamondChase").Trim();
				BossStrangeStormMysteriousDiamondMartialArts = Config.IniReadValust("StoneConfiguration", "BossStrangeStormMysteriousDiamondMartialArts").Trim();
				是否启用跑卡技能 = int.Parse(Config.IniReadValue("GameServer", "是否启用跑卡技能").Trim());
				BossMonsterStormIceApparitionColdJadeTypeSetting = ((!(Config.IniReadValust("StoneConfiguration", "BossMonsterStormIceApparitionColdJadeTypeSetting").Trim() == "")) ? int.Parse(Config.IniReadValust("StoneConfiguration", "BossMonsterStormIceApparitionColdJadeTypeSetting").Trim()) : 0);
				BossMonsterStormAttributeStone = ((!(Config.IniReadValust("StoneConfiguration", "BossMonsterStormAttributeStone").Trim() == "")) ? int.Parse(Config.IniReadValust("StoneConfiguration", "BossMonsterStormAttributeStone").Trim()) : 0);
				BossStrangeViolentUniverseDiamond = Config.IniReadValust("StoneConfiguration", "BossStrangeViolentUniverseDiamond").Trim();
				BossMonsterViolentCondensationFrostColdJadeTypeSetting = ((!(Config.IniReadValust("StoneConfiguration", "BossMonsterViolentCondensationFrostColdJadeTypeSetting").Trim() == "")) ? int.Parse(Config.IniReadValust("StoneConfiguration", "BossMonsterViolentCondensationFrostColdJadeTypeSetting").Trim()) : 0);
				BossStrangeViolentCondensationFrostColdJadeMartialArtsDefense = Config.IniReadValust("StoneConfiguration", "BossStrangeViolentCondensationFrostColdJadeMartialArtsDefense").Trim();
				BossMonsterViolentFrostAndColdJadeDefense = Config.IniReadValust("StoneConfiguration", "BossMonsterViolentFrostAndColdJadeDefense").Trim();
		...
		{
			SafePlace.Add(new CoordinateClass
			{
				Rxjh_ID = "safezone_" + SafeZoneMap,
				Rxjh_Name = "SafePlace",
				Rxjh_Map = SafeZoneMap,
				Rxjh_X = SafeAreaXCoordinate,
				Rxjh_Y = SafeAreaYCoordinate,
				Rxjh_Z = 15f
			});
		...
		public static void Set移动()
		{
			...
			else
			{
				...
				for (int i = 0; i < dBToDataTable.Rows.Count; i++)
				{
					Map_Move.Add(new CoordinateClass
					{
