...
namespace DbClss
{
	public class Config
	{
		...
		public static string IniReadValue(string Section, string Key)
		{
			...
			GetPrivateProfileString(Section, Key, "", stringBuilder, 1024, _Path);
		...
		{
			StringBuilder stringBuilder = new StringBuilder(1024);
			GetPrivateProfileString(Section, Key, "", stringBuilder, 1024, _Pathqg);
			return stringBuilder.ToString();
		}
		...
		{
			StringBuilder stringBuilder = new StringBuilder(1024);
			GetPrivateProfileString(Section, Key, "", stringBuilder, 1024, _Pathgj);
			return stringBuilder.ToString();
		}
